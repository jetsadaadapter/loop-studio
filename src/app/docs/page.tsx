  ...
  if (!hasAccess) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50/50 px-4 py-12 dark:bg-slate-950">
        <div className="w-full max-w-md rounded-2xl border border-slate-200/60 bg-white p-8 shadow-xl transition-all dark:border-slate-800 dark:bg-slate-900">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="mt-6 text-xl font-bold tracking-tight text-slate-950 dark:text-white font-sans">
            ...
            <div className="mt-8 w-full">
              <Link
                href="/apps"
                className="flex w-full items-center justify-center rounded-xl bg-[#c20019] px-4 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-[#a30015] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#c20019] transition-all"
              >
                กลับสู่หน้าหลัก
              </Link>
            </div>
