  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex flex-col max-h-[85vh] max-w-2xl overflow-hidden p-0 border border-slate-200 bg-white rounded-3xl shadow-2xl">
        ...
        <div className="flex flex-col flex-1 min-h-0 bg-slate-50 p-5 gap-3.5">
          {/* Code Block - inner body scrolls */}
          <div className="flex flex-col flex-1 min-h-0 rounded-xl border border-slate-200/80 bg-slate-900 shadow-md overflow-hidden">
            {/* Fixed syntax header bar */}
            <div className="flex items-center justify-between border-b border-slate-800 bg-slate-950 px-4 py-2 text-[10px] font-semibold text-slate-400 font-sans rounded-t-xl shrink-0">
            ...
            <div className="flex-1 overflow-y-auto p-4 min-h-[120px]">
              {isLoading ? (
                <div className="flex flex-col items-center justify-center py-6 gap-2 text-slate-400 font-sans">
                ...
                <pre className="whitespace-pre-wrap break-words text-[11px] leading-relaxed text-slate-200 font-sans antialiased">
                  {prompt}
                </pre>
              ) : (
                <div className="py-6 text-center text-xs italic text-slate-500 font-sans">
          ...
          {/* Fixed footer tip */}
          <div className="shrink-0 rounded-xl border border-brand/10 bg-brand/[0.02] px-3.5 py-2.5 text-[10.5px] leading-relaxed text-slate-600 font-medium">
