          ...
          <div className="grid grid-cols-2 gap-4">
            <Field>
              ...
              <Input
                ...
                className="h-8 text-xs md:text-xs placeholder:text-xs font-normal bg-transparent focus:bg-transparent rounded-md border border-slate-200 outline-none focus-visible:ring-0 focus-visible:ring-transparent focus:ring-0 focus:ring-transparent focus-visible:ring-offset-0 shadow-none placeholder:text-slate-400"
              />
          ...
          <div className="grid grid-cols-2 gap-4">
            <Field>
              ...
              <Input
                ...
                className="h-8 text-xs md:text-xs placeholder:text-xs font-normal bg-transparent focus:bg-transparent rounded-md border border-slate-200 outline-none focus-visible:ring-0 focus-visible:ring-transparent focus:ring-0 focus:ring-transparent focus-visible:ring-offset-0 shadow-none placeholder:text-slate-400"
              />
              <FieldError errors={errors.department ? [{ message: errors.department }] : []} />
            </Field>

            <Field>
              <FieldLabel htmlFor="user-pos">
              ...
              <Input
                ...
                className="h-8 text-xs md:text-xs placeholder:text-xs font-normal bg-transparent focus:bg-transparent rounded-md border border-slate-200 outline-none focus-visible:ring-0 focus-visible:ring-transparent focus:ring-0 focus:ring-transparent focus-visible:ring-offset-0 shadow-none placeholder:text-slate-400"
              />
              <FieldError errors={errors.position ? [{ message: errors.position }] : []} />
            </Field>
          </div>
