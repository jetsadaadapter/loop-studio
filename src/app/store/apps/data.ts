...
// ------------------------------------------------------------
// 5) Presentation helpers used by AppTile/status badges
// ------------------------------------------------------------
// Maps status text to Tailwind classes for badge color rendering.
...
// Footer links are static UI content rendered in the store footer section.
