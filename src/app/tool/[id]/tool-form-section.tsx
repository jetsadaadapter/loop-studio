                    ...
                    <Field key={param.id} className="space-y-2.5">
                        ...
                        {param.type === 'boolean' ? (
                            ...
                            <Textarea id={param.key} placeholder={param.placeholder || `Enter ${param.label.toLowerCase()}...`}
                                ...
                                className={cn("min-h-[120px] py-3 bg-slate-50 border-slate-200 focus:bg-white focus:border-brand focus:ring-4 focus:ring-brand/10 transition-all text-sm rounded-xl px-4 resize-none", errors[param.key] && "border-red-500 focus:ring-red-500/20 bg-red-50/30")} />
                        ) : (
                            <Input id={param.key} placeholder={param.placeholder || `Enter ${param.label.toLowerCase()}...`}
                                value={String(formData[param.key] || "")} onChange={(e) => clearError(param.key, e.target.value)}
                                className={cn("h-11 bg-slate-50 border-slate-200 focus:bg-white focus:border-brand focus:ring-4 focus:ring-brand/10 transition-all text-sm rounded-xl px-4", errors[param.key] && "border-red-500 focus:ring-red-500/20 bg-red-50/30")} />
                        )}
