...
>({
  ...
  return (
    <section>
      {tabs.length > 0 ? (
        <div className="flex h-8 items-center gap-2.5 pb-0">
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`group inline-flex items-center gap-2 rounded-full border px-4 py-1.5 max-h-8 text-sm font-semibold transition-all duration-200 ${
                  isActive
